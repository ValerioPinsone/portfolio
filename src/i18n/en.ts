...
export const en: T = {
  ...
  projects: {
    ...
    items: [
      ...
      {
        title:       'BeerLocator',
        description: 'Web app to spot and find beers — search, discover and save your favourite brews.',
        tags:   ['Next.js', 'Node.js', 'MySQL'],
        href:   'https://www.beerlocator.it/',
        accent: '#00e5ff',
      },
    ],
  },
  ...
  contact: {
    ...
    line1:    'Have a project in mind or just want to have a chat?',
    line2:    'Write me.',
    github:   'github',
    linkedin: 'linkedin',
  },
